...
public final class JTextFieldSomenteLetras extends JTextField { 
	...
	private void jTextFieldKeyTyped(KeyEvent evt) { 
		...
		if((getText().length()>=getMaximoCaracteres())&&(getMaximoCaracteres()!=-1)){ //if para saber se precisa verificar também o tamanho da string do campo maior ou igual ao tamanho máximo, cancela e nao deixa inserir mais 
			evt.consume(); setText(getText().substring(0,getMaximoCaracteres())); // esta linha acima é para remover os caracters inválidos caso o usuário tenha copiado o conteúdo de algum lugar ou seja com tamanho maior que o definido 
